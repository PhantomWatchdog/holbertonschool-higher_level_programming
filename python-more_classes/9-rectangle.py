...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """
        Returns the Rectangle object with the largest area.
        ...
        Returns:
            Rectangle: The Rectangle object with the largest area.
    ...
    def square(cls, size=0):
        """
        Returns a new Square object with a given size.

        Args:
            size (int): The size of the square.

        Returns:
            Square: A new Square object with a width and height equal to size.
        """
